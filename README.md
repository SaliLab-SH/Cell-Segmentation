...
- auto-segmentataion:
  - semantic: UNet model frameworks for cell/nucleus, mitochondria semantic segmentation.
  - instance: Mask R-CNN framework for insulin vesicle instance segmentation.
- systematic analysis
  - radial distribution function (RDF): A method to separate cytosol into several regions (8 regions we selected) based on the voxel distances to the nucleus.
...
![alt text](auto-segmentation/semantic/figure/Fig-1.jpg)
...
# systematic analysis
We use radial distribution function (RDF) to calculate the organelle localization inside a cell. 

## radial distribution function (RDF)
RDF was used to calculate the probability of organelle $B$’s appearance at a distance $r$ from organelle $A$.
Here we used RDF to divide cytosol into 8 shells.
